...
<!--_html_template_end_-->`}static get properties(){return{action:{type:Object},matchIndex:{type:Number,value:-1},ariaLabel:{type:String,computed:`computeAriaLabel_(action)`,reflectToAttribute:true},hintHtml_:{type:String,computed:`computeHintHtml_(action)`}}}computeAriaLabel_(){if(this.action.accessibilityHint){return decodeString16(this.action.accessibilityHint)}return""}computeHintHtml_(){if(this.action.hint){return decodeString16(this.action.hint)}return""}}customElements.define(RealboxActionElement.is,RealboxActionElement);// Copyright 2020 The Chromium Authors. All rights reserved.
...
<div class="container">
  ...
  <cr-icon-button id="remove" class="icon-clear" aria-label="[[removeButtonAriaLabel_]]" on-click="onRemoveButtonClick_" on-mousedown="onRemoveButtonMouseDown_" title="[[removeButtonTitle_]]" hidden$="[[!removeButtonIsVisible_]]" tabindex="2">
  </cr-icon-button>
</div>
